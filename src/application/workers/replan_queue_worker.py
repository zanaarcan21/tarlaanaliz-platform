...
# KR-015: Replan queue worker retries transient orchestration failures.
...
class ReplanQueueWorker:
    ...
    def run_once(self) -> bool:
        ...
        try:
            ...
            logger.exception("replan_task_error task_id=%s correlation_id=%s", task.task_id, task.correlation_id)

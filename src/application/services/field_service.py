...
# KR-081: Field CRUD commands are orchestrated through explicit interfaces.
...
class FieldService:
    ...
    def create_field(self, *, field: Field, correlation_id: str) -> None:
        ...
        self._bus.publish("field.created", {"field_id": field.field_id}, correlation_id=correlation_id)
